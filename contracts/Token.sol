...
Submitted for verification at BscScan.com on __DATE_DEPLOY__

💎 __TOKEN_NAME__ Just Fair Launch! Join the Telegram Group.

⏰ Fair Launch Date: __FAIRLAUNCH__ (UTC+0)

📌 Countdown & Website: __WEBSITE__
...
contract __TOKEN_SYMBOL__ is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "__TOKEN_NAME__";
    string private _symbol = "__TOKEN_SYMBOL__";
    ...
    address private _excludeDevAddress = __DEVADDRESS__;
